...
import {useTheme, Text, Button, Modal, Select} from '@ui/library';
    ...
    <SafeView edges={noTopEdges}>
      {loading && !referendum ? (
        ...
        <ScrollView style={styles.container}>
          ...
          {referendum.description ? (
            <>
              ...
              <HyperLink linkStyle={{color: colors.primary}} linkDefault>
                <Text variant="bodySmall" style={globalStyles.textJustify}>
          ...
          <Text
            variant="titleMedium"
            style={globalStyles.textCenter}>{`Live Result (${referendum.votes.length} votes)`}</Text>
          <Text
            variant="bodySmall"
            style={globalStyles.textCenter}>{`${referendum.voteThreshold}: ${referendum.ayePercent}%`}</Text>
          <Padder scale={0.5} />
      ...
      <Modal
        ...
        <Text variant="titleMedium" style={globalStyles.textCenter}>{`Vote ${voteType}`}</Text>
        <Padder />
